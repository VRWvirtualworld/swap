...
contract FarmB is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address public stakeTokenAddr = 0x6e5B9FEbE03362dE87078b51f97DD256CBC538c0;
    ...
    function deposit(uint256 stakeType, uint256 amount) public payable nonReentrant {
        require(stakeType == 3 || stakeType == 6 || stakeType == 12, "stakeType error");
